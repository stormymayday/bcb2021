                        ...
                        <Card border="light" text='light' border='light' style={{ 'background-color': 'transparent', 'margin-bottom': '2rem' }}>
                            <Card.Body>
                                <a href="https://www.bext360.com/" target="_blank">
                                    <Card.Img className="d-block mx-auto img-fluid w-50" variant="top" src={bextlogo} style={{ 'padding-bottom': '2rem' }} />
                                </a>
                                <Card.Text>
                        ...
                        <Card border="light" text='light' border='light' style={{ 'background-color': 'transparent', 'margin-bottom': '2rem' }}>
                            <Card.Body>
                                <a href="https://www.ideglobal.org/" target="_blank">
                                    <Card.Img className="d-block mx-auto img-fluid w-50" variant="top" src={idelogo} style={{ 'max-width': '9.3rem', 'padding-bottom': '2rem' }} />
                                </a>
                                <Card.Text>
